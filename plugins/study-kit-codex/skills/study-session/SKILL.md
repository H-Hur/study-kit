...
1. If anything has been recovered into `docs/inbox/`, read it first and move handled files to
   the archive.
2. Run the [`comprehension-auditor`](../comprehension-auditor/SKILL.md) agent to find concepts not understood from what was asked
...
6. If there is no diagnostic drill yet, build one with the [`drill-designer`](../drill-designer/SKILL.md) agent.
