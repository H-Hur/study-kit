...
[the method](method.md). Read the [runtime notes](codex-runtime.md) for the active host
...
use the quality-focused model guidance in the [runtime notes](codex-runtime.md).**
...
- **Delegate bounded research when the host supports it.** Keep noisy acquisition
  work out of the main conversation by handing it to [`source-scout`](../skills/source-scout/SKILL.md) and recovering
...
> so reading five directly ends the session by itself. [`source-scout`](../skills/source-scout/SKILL.md), [`textbook-auditor`](../skills/textbook-auditor/SKILL.md),
> and [`comprehension-auditor`](../skills/comprehension-auditor/SKILL.md) read and **return only the conclusion**. Do not lower the
