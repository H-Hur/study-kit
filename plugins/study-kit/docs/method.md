...
Procedure: the [`source-index`](../skills/source-index/SKILL.md) skill, the [`source-scout`](../agents/source-scout.md) agent.
...
Procedure: the [`curriculum-design`](../skills/curriculum-design/SKILL.md) skill, the [`drill-designer`](../agents/drill-designer.md) agent.
...
checking, it is a specialist role.** The [runtime notes](runtime.md) describe how
